...
export default function UpcomingEvents() {
  ...
  const events = [
    ...
    {
      title: 'I Congreso Nacional de Urgencias Quirúrgicas',
      date: '4 y 5 de Septiembre 2026',
      location: 'Hotel Costa del Sol, San Isidro, Lima - Perú',
      time: 'Presencial - 2 jornadas',
      attendees: '+200',
      description: 'Congreso auspiciado por SAMPRE, organizado por la Clínica San Pablo La Victoria y CCES SALUD (Grupo San Pablo). Dos jornadas con especialistas nacionales e internacionales en trauma abdominal, cuidados críticos quirúrgicos, neurocirugía de urgencias, cirugía cardiovascular, ORL, coloproctología, trauma pediátrico, urología, cirugía plástica reconstructiva y anestesia. Enfoque multidisciplinario orientado a la toma de decisiones oportunas y el trabajo colaborativo en emergencias quirúrgicas.',
      category: 'Auspicio Internacional',
      featured: false,
      image: getImageUrl(eventImages.congresoUrgenciasQuirurgicas2026),
      website: 'https://cces-salud.com/eventos/i-congreso-nacional-urgencias-quirurgicas/',
      registrationLink: 'https://wa.me/+51945146371',
    },
    {
